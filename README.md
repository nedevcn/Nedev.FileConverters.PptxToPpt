...
- ✅ Connectors include explicit start/end coordinates
...
2. **Complex shapes & SmartArt** – groups (including better scaling/rotation semantics) with proper child transform propagation, accurate individual shape transforms, connectors with endpoints, Bézier paths, and custom geometry.
